        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <input type="hidden" class="form-control" id="id" name="id" value=" <?= $data_tukar->id; ?>">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="produk_baru" name="produk_baru">
                                ...
                                <option <?php if ($data_tukar->produk_baru == $row->nama) : echo "selected";
                                                        endif; ?> value="<?= $row->nama ?>" data-harga="<?= $row->harga ?>"><?= $row->nama ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="harga_baru" name="harga_baru" readonly value="<?= $data_tukar->harga_baru; ?>">
                            <small class="text-danger">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="produk_lama" name="produk_lama" value="<?= $data_tukar->produk_lama; ?>">
                            <small class="text-danger">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="harga_lama" name="harga_lama" value="<?= $data_tukar->harga_lama; ?>">
                            <small class="text-danger">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="total_bayar" name="total_bayar" value="<?= $data_tukar->total_bayar; ?>">
                            <small class="text-danger">
